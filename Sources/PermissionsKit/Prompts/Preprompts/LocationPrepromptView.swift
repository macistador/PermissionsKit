...
struct LocationPrepromptView: View {
...
#Preview {
    LocationPrepromptView(text: "Find the best around you",
                          viewModel: PermissionPromptViewModel(permission: .location(usage: .inUse), promptKind: .preprompt(reoptinFallback: false)))
}
